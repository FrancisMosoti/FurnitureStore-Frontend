...
const Hero = () => {
  return (
    <div className="bg-[#365A4C] text-center md:text-start text-white flex justify-between p-10 flex-col md:flex-row items-center">
      <div className="flex flex-col space-y-10 md:w-1/2 mt-16">
        ...
        <div className="flex justify-center md:justify-start space-x-2 gap-4">
