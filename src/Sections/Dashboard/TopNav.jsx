...
const TopNav = () => {
  return (
    <div className="w-full fixed bg-white/20 backdrop-blur-sm border border-white/30 shadow-lg flex flex-col sm:flex-row justify-between items-start sm:items-center p-3  gap-2">
      {/* Greeting */}
